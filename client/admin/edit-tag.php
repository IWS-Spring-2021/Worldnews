...
$url = "http://localhost/worldnews/webservices/api/get_a_tag.php?id=$id";
$news = curl_init($url);
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="../components/edit_a_tag.php?id=<?php echo $_GET['id'] ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input name="tag_name" id="tag_name" value="<?php echo $result['tag_name'] ?>" class="form-control"></input>
                                    </div>
                                </div>
                                ...
                                $target_action = "Edit";
                                $target_id = $_GET['id'];
                                $confirm_message = "Confirm saving the changes with Tag id " . $target_id . " ?";

                                $file_controller = "components/edit_a_tag.php";
