...
//   'author' => $_POST['author'], 'created_date' => $_POST['created_date'], 'pic' => $_POST['pic'], 'cat_id' => $_POST['cat_id'], 'cat_id' => $_POST['cat_id'] );
//   $data_string = json_encode($data);
  $id= $_GET['id'];
//   $login_user = $_POST['name'];
$url = "http://localhost/worldnews/webservices/api/delete_cat.php?id=$id";
    $curl = curl_init($url);
