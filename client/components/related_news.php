<?php
$id = $_GET['id'];
$url = "http://localhost/worldnews/webservices/api/get_all_tags_of_a_news.php?id=$id";
...
foreach ($result as $key => $value) :
    $tag_id = $value['id'];
    $urlR = "http://localhost/worldnews/webservices/api/read_news_related.php?id=$tag_id";
    $news = curl_init($urlR);
